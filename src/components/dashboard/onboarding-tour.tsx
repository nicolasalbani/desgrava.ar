...
import { Check, User, KeyRound, FileText, Send, ArrowRight, Sparkles } from "lucide-react";
...
const steps: StepDef[] = [
  ...
  },
  {
    ...
    completedDescription: "Comprobantes cargados",
    icon: FileText,
      ...
      {!allDone && (
        ...
        >
          <div className="mb-2.5 flex items-center justify-between">
            ...
            <p className="text-muted-foreground text-xs tabular-nums">{completedCount}/4</p>
          </div>
...
function StepCard({ step, state, index }: { step: StepDef; state: StepState; index: number }) {
